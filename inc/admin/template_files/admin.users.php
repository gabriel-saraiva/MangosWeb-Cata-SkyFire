					...
					<div class="field">
						...
						<select name="expansion" class='small'>
							<?php
								...
								{
									echo "<option value='3' selected='selected'>Cataclysim</option><option value='2' selected='selected'>WotLK</option><option value='1'>TBC</option><option value='0'>Classic</option>";
								}
								elseif($profile['expansion'] == 1)
								{
									echo "<option value='3'>Cataclysim</option><option value='2'>WotLK</option><option value='1' selected='selected'>TBC</option><option value='0'>Classic</option>";
								}
								else
								{
									echo "<option value='3'>Cataclysim</option><option value='2'>WotLK</option><option value='1'>TBC</option><option value='0' selected='selected'>Classic</option>";
								}
							?>
						</select>
					</div>
