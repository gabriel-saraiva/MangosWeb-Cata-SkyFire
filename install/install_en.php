...
if($disabled == TRUE)
{
	echo "Installer Disabled. Please edit you /install/install_en.php file to re-enable the installer";
	die();
}
...
<head>
	...
	<title>MangosWeb SkyFire Installer</title>
...
<body>
	...
	<div class="page">
		<div class="content">				
			...
			?>		
					<!-- STEP 1 -->
					<form method="POST" action="install_en.php?step=2" class="form label-inline">
			...
			<?php
				...
				?>
					<!-- STEP 2 -->
					<form method="POST" action="install_en.php?step=3" class="form label-inline">
					<div class="main-content">		
						<p>
			...
			<?php
				...
				{ ?>
					<!-- STEP 3 -->
					<form method="POST" action="install_en.php?step=4" class="form label-inline">
					<div class="main-content">		
						
						<div class="field">
							<label for="db user">MySQL Host: </label>
							<input id="Site Title" name="db_host" size="20" type="text" class="medium" value="localhost" />
							<p class="field_help">Enter you MySQL host.</p>
						</div>
						
						<div class="field">
							<label for="db user">MySQL port: </label>
							<input id="Site Title" name="db_port" size="20" type="text" class="medium" value="3306" />
							<p class="field_help">Enter the port number of your MySQL.</p>
						</div>
						
						<div class="field">
							<label for="db user">MySQL Username: </label>
							<input id="Site Title" name="db_username" size="20" type="text" class="medium" value="skyfire" />
							<p class="field_help">Enter you MySQL username.</p>
						</div>
						
						<div class="field">
							<label for="db user">MySQL Password: </label>
							<input id="Site Title" name="db_password" size="20" type="password" class="medium" value="skyfire"/>
							<p class="field_help">Enter you MySQL Password.</p>
						</div>
						
						<div class="field">
							<label for="db user">Auth Database: </label>
							<input id="Site Title" name="db_name" size="20" type="text" class="medium" value="auth" />
							<p class="field_help">Enter your Auth database.</p>
						</div>
			...
			<?php
				...
				?>
				<!-- STEP 4 -->
					<form method="POST" action="install_en.php?step=5" class="form label-inline">
				...
				?>
					<form method="POST" action="install_en.php?step=6" class="form label-inline">
					<input type="hidden" name="db_host" value="<?php echo $_POST['db_host']; ?>">
					<input type="hidden" name="db_port" value="<?php echo $_POST['db_port']; ?>">
					<input type="hidden" name="db_name" value="<?php echo $_POST['db_name']; ?>">
					<input type="hidden" name="db_username" value="<?php echo $_POST['db_username']; ?>">
				...
				<div class="main-content">		
					<p>
						...
						{ ?>
							...
							Also, remember to <u><b>EDIT the install file! (install/install_en.php)</b></u>. Set the FALSE to TRUE on line 3 to prevent users or hackers
                            from invade your MangosWeb SkyFire<br /><br /><a href="../index.php">Click Here</a> To go to your MangosWeb home page.
						<?php
						} ?>
					</p>
				</div>
		...
		<div id="footer">
			<center>
			<p>
				Template originally designed by Rod Creative</a>, Modified by Wilson212 for MangosWeb and updated for SkyFire by gldss creative.<br /> 
			</p>
			</center>
		</div>
	</div>
