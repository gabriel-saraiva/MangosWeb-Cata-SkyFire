												...
												<table border='0' cellspacing='0' cellpadding='0'>
													<tr>
														<td>
															<select name="exp">
															<?php
																if($profile['expansion'] == 3)
																{
																	echo "<option value='3' selected='selected'>Cataclysm</option><option value='2'>Wotlk</option><option value='1'>TBC</option><option value='0'>Classic</option>";
																}
																elseif($profile['expansion'] == 2)
																{
																	echo "<option value='3' selected='selected'>Cataclysm</option><option value='2'>Wotlk</option><option value='1'>TBC</option><option value='0'>Classic</option>";
																}
